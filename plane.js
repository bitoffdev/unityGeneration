function createPlane(width: float, height : float, orientation){
	...
	if (orientation=="vertical"){
		...
		/*Define the vertices of the Mesh*/
		meshObj.vertices = [Vector3(-halfW, 0.1, -halfH), Vector3(halfW, 0.1, -halfH), Vector3(halfW, 0.1, halfH), Vector3(-halfW, 0.1, halfH)];
		/*Connect the vertices into two triangles that form a rectangular plane*/
		meshObj.triangles = [3, 2, 0, 2, 1, 0];
	}
